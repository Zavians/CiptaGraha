                    ...
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <div class="d-flex flex-row justify-content-between">
                                ...
                                <a href="{{ route('addIndexProducts') }}"
                                    class="btn bg-gradient-primary btn-sm mb-0 text-white">+&nbsp; New Product</a>
                                        ...
                                        @foreach ($dataProducts as $index => $product)
                                            <tr class="text-center">
                                                    ...
                                                    <div class="row justify-content-center">
                                                        <div class="col-md-8 mx-auto">
                                                            <div class="d-flex justify-content-center">
                                                                <div id="carouselExampleIndicators{{ $product->id }}"
                                                                    class="carousel slide" data-bs-ride="carousel">
                                                                    <div class="carousel-indicators">
                                                                        @if (is_array(json_decode($product->images)))
                                                                            <!-- Pastikan array di-decode -->
                                                ...
                                                <td class="align-middle">
                                                    ...
                                                    <a href="{{ route('editIndexProducts', $product->id) }}"
                                                        class="btn btn-danger btn-sm bg-gradient-info mb-0"><i
                                                            class="fa-solid fa-pen-to-square"
                                                            style="font-size: 12px;"></i></a>

                                                    <!-- Delete Button with Modal -->
                                                    <button type="button"
                                                        class="btn btn-danger btn-sm bg-gradient-danger mb-0"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered" role="document"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="py-3 text-center">
                                                                        ...
                                                                        <h4 class="text-gradient text-danger mt-4">You
                                                                            should read this!</h4>
                                                                        <p class="text-wrap">Activating this function will
                                                                            cause your data to be deleted</p>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form
                                                                        action="{{ route('destroyProducts', $product->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
